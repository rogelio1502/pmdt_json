...
$parentPath ="master:/sitecore/content/pmdt-jss-site/Content/Database/Promedica-Newsroom/Press Releases/Cards"
#Read CSV file
$importList = $importList =  curl 'https://rogelio1502.github.io/pmdt_json/pr_cards.json' -UseBasicParsing
